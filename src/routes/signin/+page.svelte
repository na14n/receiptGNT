        ...
        <div class="max-w-md mx-auto my-10">
            ...
            <div class="m-7">
                <form action="?/login" method="POST" use:enhance={submitLogin}> 
                    ...
                    <div class="mb-6">
                        <button class="w-full px-3 py-2 font-medium text-white bg-blue-600 rounded-md focus:bg-blue-400 focus:outline-none disabled:bg-blue-300" disabled={loading}>Sign in</button>
                    </div>
                    ...
                    <p class="mt-1 text-md text-center text-gray-600">Or perhaps you forgot your password? <a href="/signin/forgot" class="text-blue-600 underline hover:text-blue-400 dark:focus:border-indigo-800" aria-disabled={loading}>Reset it here.</a></p>
                </form>
            </div>
        </div>
    </div>
