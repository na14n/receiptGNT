        ...
        <div class="max-w-md mx-auto my-10">
            ...
            <div class="m-7">
                <form action="?/forgot" method="POST" use:enhance={submitReset}> 
                    ...
                    <div class="mb-6">
                        <button class="w-full px-3 py-2 text-white bg-blue-600 rounded-md focus:bg-blue-400 focus:outline-none disabled:bg-blue-300">Request password reset</button>
                    </div>
